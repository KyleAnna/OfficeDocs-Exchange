...
For security and performance reasons, we don't recommend installing Exchange 2019 on Active Directory servers. Only install Exchange 2019 on member servers.
